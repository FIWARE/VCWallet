        ...
        <div class="w3-container w3-padding-16">       
          ...
          <div class="w3-dropdown-hover">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-border w3-padding-small">
              ...
              <button class="w3-bar-item w3-button" @click=${() => getCompliancyCredential(theData,"https://gx-compliance.aruba.it/v1/api/credential-offers")}>${T("Aruba Compliance Service")}</button>
